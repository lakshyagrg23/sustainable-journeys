...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['adventure', 'waterActivity', 'beach', 'travel', 'sightseeing']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    sub_activites: Schema.Attribute.Relation<
      'oneToMany',
      'api::sub-activite.sub-activite'
    >;
...
export interface ApiCapCap extends Struct.CollectionTypeSchema {
  collectionName: 'caps';
  info: {
    displayName: 'cap';
    pluralName: 'caps';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::cap.cap'> &
      Schema.Attribute.Private;
...
export interface ApiHotelRoomHotelRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Amenities: Schema.Attribute.Component<'repeatable.amenities', true>;
    category: Schema.Attribute.Enumeration<
      ['Luxury', 'Budget', 'Standard', 'Deluxe']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    new_category: Schema.Attribute.String;
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['luxury', 'budget', 'premium']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gallery: Schema.Attribute.Media<'images' | 'files'>;
    hotel_rooms: Schema.Attribute.Relation<
      'oneToMany',
      'api::hotel-room.hotel-room'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPackagePackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Whats_Included: Schema.Attribute.Component<
      'repeatable.whats-included-item',
      true
    >;
  };
}
...
export interface ApiSubActiviteSubActivite extends Struct.CollectionTypeSchema {
  collectionName: 'sub_activites';
  info: {
    displayName: 'sub_activite';
    pluralName: 'sub-activites';
    singularName: 'sub-activite';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    gallery: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    hero_section: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
